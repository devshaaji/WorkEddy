...
<div x-data="orgUsersPage">
  ...
  <div class="page-header">
    <div>
      ...
      <p class="page-breadcrumb">Organization / Team</p>
    </div>
  ...
  <div class="card">
    ...
    <div class="table-toolbar">
      <div class="search-box">
        ...
        <input class="form-control" type="search"
               placeholder="Search members…" x-model="memberSearch">
      </div>
    ...
    <div class="table-responsive"
         x-show="!loading && !error && members.length > 0" x-cloak>
            ...
            <tr>
              <td>
                <div class="d-flex align-items-center gap-2">
                  <div class="avatar avatar-sm"
                       :class="'avatar-' + (m.role === 'admin' ? 'primary'
              ...
              <td>
                <span class="badge text-capitalize"
                      :class="roleBadge(m.role)" x-text="m.role"></span>
              </td>
              <td>
                <span class="badge"
              ...
              <td class="text-end">
                <div class="dropdown">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    <li>
                      <button class="dropdown-item text-danger" @click="confirmRemove(m)">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="mb-3">
            ...
            <input class="form-control" id="invName" type="text"
                   x-model="inviteForm.name" placeholder="John Smith">
          </div>
          <div class="mb-3">
            <label class="form-label" for="invEmail">Email <span class="text-danger">*</span></label>
            <input class="form-control" id="invEmail" type="email"
                   x-model="inviteForm.email" placeholder="john@company.com">
          </div>
          <div class="mb-3">
            <label class="form-label" for="invPass">Temporary Password <span class="text-danger">*</span></label>
            <input class="form-control" id="invPass" type="text"
                   x-model="inviteForm.password" placeholder="Min 8 characters">
  ...
  <div class="modal fade" id="roleModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-sm">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-light" data-bs-dismiss="modal">Cancel</button>
          <button type="button" class="btn btn-primary" @click="saveRole()">Update</button>
        </div>
      </div>
    </div>
  </div>
      ...
      <div class="modal-content">
        <div class="modal-header border-0 pb-0">
          <h6 class="modal-title text-danger">
            <i class="bi bi-person-dash me-2"></i>Remove Member
          </h6>
          <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
        </div>
        <div class="modal-body">
          <p class="mb-0">
            Remove <strong x-text="removingMember?.name"></strong>
